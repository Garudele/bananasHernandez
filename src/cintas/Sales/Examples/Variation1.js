                      ...
                      <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                        <ResponsiveContainer height="100%">
                          <AreaChart data={data552}
                            ...
                            <Area type="monotoneX" dataKey="uv" stroke="var(--success)" strokeWidth="3"
                      ...
                      <TabPane tabId="1">
                        ...
                        <ResponsiveContainer height={244}>
                          <BarChart data={data2}>
                            <XAxis dataKey="name" />
                            <Legend />
                            <Bar barGap="12" dataKey="Sales" stackId="a" fill="var(--info)"/>
                            <Bar barGap="12" dataKey="Downloads" stackId="a" fill="var(--info)" fillOpacity=".15"/>
                          </BarChart>
                        </ResponsiveContainer>
                      </TabPane>
                      <TabPane tabId="2">
                ...
                <Card className="mb-3">
                  ...
                  <CardBody>
                    <ReactTable data={data}
                      ...
                      defaultPageSize={10} className="-striped -highlight -hide-paging"/>
                  </CardBody>
                </Card>
              </Col>
              <Col md="12" lg="6" xl="4">
