                          ...
                          <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                            <ResponsiveContainer height="100%">
                              <BarChart data={data222}>
                                <Bar barGap="12" dataKey="Sales" stackId="a" fill="var(--primary)"/>
                                <Bar barGap="12" dataKey="Downloads" fillOpacity=".2" stackId="a" fill="var(--primary)"/>
                              </BarChart>
                            </ResponsiveContainer>
                          </div>
                        </div>
                            ...
                            <div className="widget-chart-flex">
                              <div className="widget-numbers">
                                <div className="widget-chart-flex">
                                  ...
                                  <div className="widget-title ml-md-2 opacity-5 font-size-lg text-muted">
                          ...
                          <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                            <ResponsiveContainer height="100%">
                              <LineChart data={data55}
                                ...
                                <Line type="monotone" dataKey="pv" stroke="var(--success)" strokeWidth={3}/>
                                <Tooltip />
                              </LineChart>
                            </ResponsiveContainer>
                          </div>
                          ...
                          <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                            <ResponsiveContainer height="100%">
                              <AreaChart data={data55}
                                ...
                                <Tooltip />
                                <Area type="monotoneX" dataKey="uv" strokeWidth={0} fill="var(--yellow)" fillOpacity=".4"/>
                              </AreaChart>
                            </ResponsiveContainer>
                          </div>
                        </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge badge-pill pl-2 pr-2 badge-warning">
                      Pending
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge badge-pill pl-2 pr-2 badge-success">
                      Completed
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge badge-pill pl-2 pr-2 badge-danger">
                      In Progress
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge badge-pill pl-2 pr-2 badge-info">
                      On Hold
                    </div>
                  </td>
                  <td>
